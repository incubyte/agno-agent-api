...
class MarketingAgent(BaseAgent):
    def __init__(self):
        super().__init__(
            ...
            description="An AI specialist in marketing analysis, strategy development, and campaign optimization that conducts complete marketing reviews and optimizations of websites."
        )
    ...
    def _create_marketing_website_team(self):
        return Agent(
            ...
            model=Claude(id="claude-3-5-sonnet-20241022", max_tokens=12000),
            instructions=[
